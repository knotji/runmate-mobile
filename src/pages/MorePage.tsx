      ...
      <IonContent ref={contentRef} fullscreen className="more-content">
        <main className="more-shell">
          ...
          {/* Dev-only entry point into the isolated WholeMate Next prototype
              ...
              through PERSONAL_CONTROLS/warmPage. Intentionally not a
              redirect: /tabs/* keeps shipping the current app so the two
              can be compared side by side until WholeMate Next is ready to
              replace it. */}
