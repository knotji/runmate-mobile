  ...
  return <IonPage>
    ...
    <IonContent fullscreen className="pain-trends-content">
      ...
      <main className="pain-trends-shell">
        ...
        {trend && trend.logs.length === 0 && <PageState kind="empty" icon={checkmarkCircleOutline} title="No Pain Reports In This Range" detail="WholeMate loaded this range successfully and found no pain or injury reports." actionLabel="Review Move" onAction={() => history.push('/tabs/move')} className="pain-trends-state" />}
